...
class PropostasForm(BaseForm):
    ...
    diaFechamento = StringField('Dia do Fechamento',render_kw={'maxlength':'255'},validators=[validators.DataRequired()])
    vigenciaInicial = DateField('Dia da vigência Inicial',render_kw={'maxlength':'255'},validators=[validators.DataRequired()])
    vigenciaFinal = DateField('Data da vigência Final',render_kw={'maxlength':'255'},validators=[validators.DataRequired()])
    diaVencimento = StringField('Dia do Fechamento',render_kw={'maxlength':'255'},validators=[validators.DataRequired()])
    prazoVencimento =  StringField('Prazo do Fechamento',render_kw={'maxlength':'255'},validators=[validators.DataRequired()])